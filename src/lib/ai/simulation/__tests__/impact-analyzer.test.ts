    ...
    bottlenecks: [
      {
        ...
        utilization: 100,
        threshold: 85,
        impact: 'Unable to meet increased demand',
        recommendations: [
          {
            action: 'Consider adding overtime or second shift',
            priority: 1,
    ...
    alerts: [
      {
        ...
        threshold: 500,
        actualValue: 550,
        recommendation: 'Increase safety stock buffer',
      },
      {
        type: 'stockout',
        severity: 'critical',
        ...
        threshold: 0,
        actualValue: 250,
        recommendation: 'Expedite orders or increase production',
      },
    ],
    recommendations: [],
    ...overrides,
