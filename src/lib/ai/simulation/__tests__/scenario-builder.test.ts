...
describe('ScenarioBuilder', () => {
  ...
  describe('createScenario', () => {
    it('should create a demand scenario with valid config', () => {
      ...
      expect(scenario.config.parameters.demandChange).toBe(25);
    ...
    it('should create a supply scenario', () => {
      ...
      expect(scenario.config.parameters.leadTimeChange).toBe(14);
    });
    ...
    it('should create a capacity scenario', () => {
      ...
      expect(scenario.config.parameters.capacityChange).toBe(-20);
    });
