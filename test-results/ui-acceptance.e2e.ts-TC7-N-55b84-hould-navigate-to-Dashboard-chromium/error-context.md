...
- generic [active] [ref=e1]:
  ...
  - region "Notifications alt+T":
    - list:
      - listitem [ref=e278]:
        - generic [ref=e279]:
          - generic [ref=e280]: New Pro Features Available
          - generic [ref=e281]: Try "Dense Mode" in tables and use "Ctrl+Enter" to save forms instantly.
        - button "Got it" [ref=e282] [cursor=pointer]
  - alert [ref=e283]
```