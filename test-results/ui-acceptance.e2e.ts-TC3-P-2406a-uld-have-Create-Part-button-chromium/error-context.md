...
- generic [active] [ref=e1]:
  ...
  - region "Notifications alt+T":
    - list:
      - listitem [ref=e1110]:
        - generic [ref=e1111]:
          - generic [ref=e1112]: New Pro Features Available
          - generic [ref=e1113]: Try "Dense Mode" in tables and use "Ctrl+Enter" to save forms instantly.
        - button "Got it" [ref=e1114] [cursor=pointer]
  - alert [ref=e1115]
```