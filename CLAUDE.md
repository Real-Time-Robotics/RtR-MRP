# CLAUDE.md - RTR-MRP AI Kernel Configuration

> **This file configures Claude Code behavior for the RTR-MRP project.**
...
*This file is the source of truth for AI behavior in RTR-MRP. For detailed guidelines, see the full Master Prompt document.*
